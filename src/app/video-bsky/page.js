            ...
            <div className="min-h-screen flex p-8 justify-center max-w-6xl rounded-lg mt-20">
                <div className="p-8 flex flex-col">
                    ...
                    <p className="text-lg max-sm:text-base text-justify leading-relaxed">
                        Você está acessando uma página antiga de um projeto para a Bluesky, que infelizmente foi descontinuado. O projeto consistia em um site que permitia baixar vídeos da rede social Bluesky.
                    </p>
                </div>
            </div>
        </>
